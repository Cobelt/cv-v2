...
export default function Logo({ className }: WithClassNameProps) {
  return (
    <Link href="/">
      <h2
        className={cN(
          "group flex text-3xl md:text-5xl font-bukhari min-w-20 underline-rounded",
          className
        )}
        style={
          {
      ...
      >
        ...
        <div className="bounce-in relative">
          <span
            className={cN(
              "w-2 h-2 bg-stone-50 rounded-full inline-block origin-[-0.55rem_bottom] xl:origin-[-0.45rem_bottom] opacity-100 [transition:transform_0s,opacity_0.3s_0.55s]",
